Contains the Adafruit WS2801 library code plus a derived class containing all additional code added for the Zoa project (kept separate to ensure we don't accidentally break the library).

Original comments for the Adafruit library are below.
